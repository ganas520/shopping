...
public class HmacReturnbyday {
     ...
     * 请求coupang接口
     * */
    public static  String test(String status,String yearMonth) {
    	String[] yearTime = getYearMonth(yearMonth);
        //params
        String method = "GET";
        //replace with your own vendorId
        String path = "/v2/providers/openapi/apis/api/v4/vendors/C00216356/ordersheets";
        ...
        try {
            ...
            URIBuilder uriBuilder = new URIBuilder()
                    .setPath(path)
                    .addParameter("createdAtFrom", yearMonth+"-"+yearTime[0])
                    .addParameter("createdAtTo", yearMonth+"-"+yearTime[1])
...
//                System.out.println("result:" + EntityUtils.toString(entity));
    ...
    private static String[] getYearMonth(String yearMonth) {
    	String[] yearMonthStr = {"",""};
    	String firstData = "01";
    	String lastData = "";
    	...
    	yearMonthStr[0] = firstData;
    	yearMonthStr[1] = lastData;
    	return yearMonthStr;
    }
}
